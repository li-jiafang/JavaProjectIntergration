...
public class CodeGenerator {
    ...
    private static String projectPath = "D:\\Java\\Ljf\\JavaProjectIntergration\\200_SpringBoot_Integration";
    private static String author = "ljf";

    private static String moduleName = "project";
    private static String parentPackage = "com.ljf";

    private static String url = "jdbc:mysql://10.1.65.12:3306/hello?useUnicode=true&useSSL=false&characterEncoding=utf8";
